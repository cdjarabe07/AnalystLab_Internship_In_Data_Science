...
| !\[Attrition by Department](visuals/attrition\_by\_department.png) | !\[Attrition by OverTime](visuals/attrition\_by\_overtime.png) |
...
| !\[Income boxplot](visuals/boxplot\_income\_attrition.png) | !\[Attrition pie chart](visuals/attrition\_pie.png) |
...
│   └── 01\_week1\_exploration.ipynb

├── reports/

│   ├── business\_understanding\_report.docx

│   ├── dataset\_inspection\_report.docx

│   └── reflection\_report.docx
...
Then open `notebooks/01\_week1\_exploration.ipynb` in VS Code or Jupyter and select the `venv`
