...
![Outcome distribution](week4/visuals/01_outcome_distribution.png)

## Files

- `week4/notebooks/week4_initial_data_assessment.ipynb`
- `week4/reports/ml_problem_definition_document.docx`
- `week4/reports/week4_project_summary.docx`
- `docs/` — data dictionary, clinic knowledge base, assignment briefs
